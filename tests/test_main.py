"""Tests for py_smart_verify.__main__."""
...
def test_main_imports_app():
    ...
    sys.modules.pop("py_smart_verify.__main__", None)
    from py_smart_verify.__main__ import app
    from py_smart_verify.cli import app as cli_app
...
def test_main_guard():
    ...
    sys.modules.pop("py_smart_verify.__main__", None)
    with patch("py_smart_verify.cli.app") as _mock_app:
        # Simulate running as __main__
        import py_smart_verify.__main__

        # The if __name__ == "__main__" block won't trigger during import,
        # but we verify the module structure is correct
        assert hasattr(py_smart_verify.__main__, "app")
